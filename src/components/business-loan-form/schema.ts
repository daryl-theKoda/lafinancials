...
const ownerSchema = z.object({
  ...
  ownershipPercentage: z.coerce.number().min(0).max(100, "Ownership percentage must be between 0 and 100"),
  bankName: z.string().min(1, "Bank name is required"),
  accountNumber: z.string().min(1, "Account number is required"),
  averageMonthlyBalance: z.coerce.number().min(0, "Must be a positive number"),
...
const referencesSchema = z.object({
  ...
  bank: z.object({
    ...
    yearsWithBank: z.coerce.number().optional(),
  }),
  other1: z.object({
    name: z.string().optional(),
    phone: z.string().optional(),
...
export const businessLoanFormSchema = z.object({
  ...
  yearsInBusiness: z.coerce.number().min(0, "Must be a positive number"),
  numberOfEmployees: z.coerce.number().min(0, "Must be a positive number"),
  ...
  annualTurnover: z.coerce.number().min(0, "Must be a positive number"),
  projectedTurnover: z.coerce.number().min(0, "Must be a positive number"),
  grossProfit: z.coerce.number().min(0, "Must be a positive number"),
  netProfit: z.coerce.number().min(0, "Must be a positive number"),
  bankName: z.string().min(1, "Bank name is required"),
  accountNumber: z.string().min(1, "Account number is required"),
  averageBalance: z.coerce.number().min(0, "Must be a positive number"),
